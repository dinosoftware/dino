...
var user_1 = require("../api/opensubsonic/user");
    ...
    fetchUser: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, user_1.getCurrentUser)()];
                case 2:
                    user = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('[UserStore] Failed to fetch user:', error_1);
                    set({
                        error: error_1 instanceof Error ? error_1.message : 'Failed to fetch user',
                        isLoading: false
                    });
                    return [3 /*break*/, 4];
