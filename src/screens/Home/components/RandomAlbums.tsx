/**
 * Dino Music App - Random Albums Component
 * Displays random albums from the library
 */
...
export const RandomAlbums: React.FC = () => {
  const { currentServerId } = useServerStore();
  const { data: response, isLoading, refetch } = useQuery({
    queryKey: ['random-albums', currentServerId],
    queryFn: async () => getAlbumList2('random', 20),
    staleTime: 5 * 60 * 1000,
