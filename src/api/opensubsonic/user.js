...
exports.getUser = exports.getCurrentUser = void 0;
...
var getCurrentUser = function () { return __awaiter(void 0, void 0, void 0, function () {
    var auth, tokenInfo, username, response, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                auth = authStore_1.useAuthStore.getState().getCurrentServerAuth();
                if (!(auth === null || auth === void 0 ? void 0 : auth.apiKey)) return [3 /*break*/, 3];
                console.log('[User API] Using API key auth, fetching tokenInfo...');
                return [4 /*yield*/, client_1.apiClient.request('tokenInfo')];
            case 1:
                tokenInfo = _a.sent();
                username = tokenInfo.tokenInfo.username;
                console.log('[User API] Got username from tokenInfo:', username);
                return [4 /*yield*/, client_1.apiClient.request('getUser', {
                        username: username,
                    })];
            case 2:
                response = _a.sent();
            ...
            case 3:
                if (!(auth === null || auth === void 0 ? void 0 : auth.username)) return [3 /*break*/, 5];
            ...
            case 4:
                response = _a.sent();
                return [2 /*return*/, response.user];
            case 5: throw new Error('No authentication credentials available');
        }
    });
}); };
...
var getUser = function (username) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client_1.apiClient.request('getUser', {
                    username: username,
                })];
            case 1:
                response = _a.sent();
